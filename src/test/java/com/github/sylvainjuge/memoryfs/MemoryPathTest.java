...
public class MemoryPathTest {
    ...
    public void equalsHashCodeWithItself() {
        ...
        TestEquals.checkHashCodeEqualsConsistency(true, p, p);
    ...
    public void equalsHashCodeWithSamePartsButAbsoluteness() {
        ...
        TestEquals.checkHashCodeEqualsConsistency(false, p1, p2);
    }

    @Test
    public void equalsHashCodeWithEquivalent() {
        TestEquals.checkHashCodeEqualsConsistency(true,
                createPath("/"),
                createPath("///"),
                createPath("//"));
        TestEquals.checkHashCodeEqualsConsistency(true,
    ...
    public void equalsHashCodeWithDifferent() {
        TestEquals.checkHashCodeEqualsConsistency(false,
                createPath("/a"),
                createPath("/b"));
        TestEquals.checkHashCodeEqualsConsistency(false,
                createPath("a"),
